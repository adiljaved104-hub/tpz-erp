...
class UpdateProduct
{
    ...
    private function attributes(UpdateProductData $data): array
    {
        return [
            ...
            'processor_class' => $this->nullable($data->processorClass),
            'processor_model' => $this->nullable($data->processorModel),
            'processor_generation' => $this->nullable($data->processorGeneration),
            ...
            'is_convertible_360' => $data->isConvertible360,
            'accounting_title_override' => $this->nullable($data->accountingTitleOverride),
            'website_title_override' => $this->nullable($data->websiteTitleOverride),
    ...
    private function rules(UpdateProductData $data): array
    {
        return [
            ...
            'processor_model' => ['nullable', 'string', 'max:255'],
            'processor_generation' => ['nullable', 'string', 'max:255'],
            ...
            'is_convertible_360' => ['nullable', 'boolean'],
            'accounting_title_override' => ['nullable', 'string', 'max:255'],
            'website_title_override' => ['nullable', 'string', 'max:255'],
