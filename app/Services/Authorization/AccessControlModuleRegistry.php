...
class AccessControlModuleRegistry
{
    ...
    public function modules(): array
    {
        $modules = [
            ...
            $this->module('inventory', 'Inventory & Opening Stock', 'products_inventory', [InventoryPermission::View], [InventoryPermission::PostOpeningStock, InventoryPermission::ReverseOpeningStock, InventoryPermission::Reserve, InventoryPermission::ReleaseReservation, InventoryPermission::MarkDamaged, InventoryPermission::RestoreDamaged], [InventoryPermission::ViewMovements, InventoryPermission::Export, InventoryPermission::ViewFinancials, InventoryPermission::ViewAllocations, InventoryPermission::ManageAllocations, InventoryPermission::ManageAllocationSettings, InventoryPermission::ViewStockRequests, InventoryPermission::CreateStockRequests, InventoryPermission::DecideOwnStockRequestSources, InventoryPermission::DecideAllStockRequestSources, InventoryPermission::ExecuteStockRequests]),
            ...
            $this->module('quotations', 'Quotations / Proforma', 'quotations_invoices', [QuotationPermission::View], [QuotationPermission::Create, QuotationPermission::Update], [QuotationPermission::ViewAll, QuotationPermission::Send, QuotationPermission::Accept, QuotationPermission::Reject, QuotationPermission::ConvertOrder, QuotationPermission::ConvertInvoice, QuotationPermission::Cancel, QuotationPermission::Export, QuotationPermission::SourceInventory, QuotationPermission::ViewSourceCost]),
            $this->module('tax_invoices', 'Tax Invoices', 'quotations_invoices', [InvoicePermission::View], [InvoicePermission::Create], [InvoicePermission::ViewAll, InvoicePermission::EditCustomerDetails, InvoicePermission::Void, InvoicePermission::DownloadPdf, InvoicePermission::Export], 'Issued Invoice financial and commercial content remains immutable; customer identity details may be corrected through the dedicated audited action.'),
