    ...
    public function groups(): array
    {
        return [
            ...
            'Orders' => [
                ...
                $this->item(OrderPermission::Amend, 'Amend Reserved Orders', true),
                $this->item(OrderPermission::AmendAfterWindow, 'Override Order Amendment Window', true),
                $this->item(OrderPermission::ManageAmendmentSettings, 'Manage Order Amendment Settings', true),
            ...
            'Inventory' => [
                ...
                $this->item(InventoryPermission::ExecuteStockRequests, 'Execute Approved Stock Requests', true),
            ],
            'Responsibility' => [
