...
class QuotationService
{
    ...
    public function create(array $data, User $actor): Quotation
    {
        ...
        return DB::transaction(function () use ($validated, $actor, $products, $priced, $reference, $profile, $settings): Quotation {
            ...
            $this->storeItems($quote, $priced['lines'], $products);
    ...
    public function updateDraft(Quotation $quotation, array $data, User $actor): Quotation
    {
        ...
        return DB::transaction(function () use ($quotation, $validated, $products, $priced, $actor): Quotation {
            ...
            $locked->items()->delete();
            $this->storeItems($locked, $priced['lines'], $products);
    ...
    private function storeItems(Quotation $quote, array $lines, $products): void
    {
