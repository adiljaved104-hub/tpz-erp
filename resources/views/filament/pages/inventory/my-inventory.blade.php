                ...
                <div class="hidden overflow-x-auto rounded-xl border border-gray-200 lg:block dark:border-white/10">
                    <table class="w-full min-w-[1040px] table-fixed divide-y divide-gray-200 text-sm dark:divide-white/10">
                        <thead class="bg-gray-50 text-left text-xs font-semibold uppercase tracking-wide text-gray-600 dark:bg-white/5 dark:text-gray-300">
                            <tr><th class="w-72 px-4 py-3">Product</th><th class="w-32 px-4 py-3">Platform</th><th class="w-32 px-4 py-3">Location</th><th class="w-24 px-4 py-3 text-center">Physical Sellable</th><th class="w-28 px-4 py-3 text-center">Allocation Remaining</th><th class="w-24 px-4 py-3 text-center">Usable Now</th><th class="w-32 px-4 py-3">Status</th><th class="px-4 py-3">Visible Because</th></tr>
                        </thead>
                        <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                            @foreach ($inventoryRows as $row)
                                <tr class="align-top">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 text-center">{{ $row->sellable }}</td>
