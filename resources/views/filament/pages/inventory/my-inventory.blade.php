            ...
            <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-white/10">
                <table class="min-w-[1180px] divide-y divide-gray-200 text-sm dark:divide-white/10">
                    <thead><tr class="text-left">
                        ...
                        <th class="px-3 py-3">My Qty</th><th class="px-3 py-3">All Assigned</th><th class="px-3 py-3">Remaining</th><th class="px-3 py-3">Capacity</th><th class="px-3 py-3">Latest Purchase Cost</th><th class="px-3 py-3">Visible Because</th>
                    </tr></thead>
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                        @foreach ($inventoryRows as $row)
                            <tr>
                                ...
                                <td class="px-3 py-3">{{ $row->assigned_quantity }}</td><td class="px-3 py-3">{{ $row->aggregate_assigned }}</td><td class="px-3 py-3">{{ $row->remaining_assignable }}</td><td class="px-3 py-3">{{ $row->capacity_status }}</td>
